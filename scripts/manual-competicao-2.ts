...
async function main() {
  ...
  const participants = [
    {
      fullName: "Gabriel Reis Santos",
      cpf: normalizeCPF("06990971509"),
      birthDate: normalizeDateBR("28/03/1997"),
      phone: normalizePhone("71-993375458"),
      email: "Gabrielabsbicicross@hotmail.com",
      city: "Bahia",
      state: "BA",
      tshirtSize: "M",
      emergencyName: null,
      emergencyPhone: normalizePhone("+55 71 98144-3279"),
      healthInfo: null,
      extras: [],
    },
    {
      fullName: "Leandra Lemes",
      cpf: normalizeCPF("05121158009"),
      birthDate: normalizeDateBR("30/07/2000"),
      phone: normalizePhone("55999474477"),
      email: "faixar043@gmail.com",
      city: null,
      state: "RS",
