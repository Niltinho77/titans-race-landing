...
function normalizePhone(phone: string) {
  // esperado: 11 dígitos (DDI+DDD+9+NNNNNNNN no padrão BR)
...
async function main() {
  ...
  // Observações:
  // - Alex: usei o 55 99958-4652 como telefone dele e 55 99633-6371 como emergência.
  // - Geovana: assumi o telefone de emergência "55 99222-9957" (11 dígitos). Ajuste se necessário.
  const participants = [
    {
      fullName: "Alex Ezequiel da Silva Nunes",
      cpf: normalizeCPF("05354312019"),
      birthDate: normalizeDateBR("15/10/2002"),
      phone: normalizePhone("55 99958-4652"),
      email: "Lelekooficial9@gmail.com",
      city: null,
      state: "RS",
      tshirtSize: "G",
      emergencyName: "Contato de emergência",
      emergencyPhone: normalizePhone("55 99633-6371"),
      healthInfo: null,
      extras: [],
    },
    {
      fullName: "Geovana Isabele da Silva Nunes Apestegui",
      cpf: normalizeCPF("06508849069"),
      birthDate: normalizeDateBR("21/07/2007"),
      phone: normalizePhone("55 99633-6371"),
      email: "geovanaapestegui56@gmail.com",
      city: "Uruguaiana",
      state: "RS",
      tshirtSize: "P",
      emergencyName: "Carlos",
      emergencyPhone: normalizePhone("55 9 9222-9957"),
      healthInfo: null,
      extras: [],
    },
  ];
