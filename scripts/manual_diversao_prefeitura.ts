...
async function main() {
  ...
  const participants = [
    {
      fullName: "Cleidivan Gomes Medeiros",
      cpf: normalizeCPF("002.458.910-13"),
      birthDate: normalizeDateBR("16/12/1976"),
      phone: normalizePhone("55991655949"),
      email: "cleidivan-medeiros@hotmail.com",
      city: null,
      state: "RS",
      tshirtSize: "M",
      emergencyName: null,
    ...
    {
      fullName: "Mateus Araújo",
      cpf: normalizeCPF("03784515029"),
      birthDate: normalizeDateBR("11/07/1997"),
      phone: normalizePhone("55997108405"),
      email: "mateusaraujo261@gmail.com",
      city: null,
      state: "RS",
      tshirtSize: "G",
      emergencyName: "Claudia Araújo",
      emergencyPhone: normalizePhone("55999231150"),
      healthInfo: null,
      extras: [],
    },
    {
      fullName: "Gil Peterson da Costa Saldanha",
      cpf: normalizeCPF("836.725.320-53"),
      birthDate: normalizeDateBR("06/10/1987"),
      phone: normalizePhone("(55)999382091"),
      email: "gil.saldanha16@gmail.com",
      city: null,
      state: "RS",
      tshirtSize: "M",
      emergencyName: null,
      emergencyPhone: normalizePhone("(55)999280831"),
      healthInfo: null,
      extras: [],
    },
  ];
