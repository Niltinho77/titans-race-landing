// scripts/manual-diversao-lote-4.ts
...
async function main() {
  ...
  // ========= PARTICIPANTES (DIVERSÃO - INDIVIDUAL) =========
  const participants = [
    {
      fullName: "Luciana Licht Cunha",
      cpf: normalizeCPF("018 254 840 66"),
      birthDate: normalizeDateBR("26/07/1985"),
      phone: normalizePhone("47 992812584"),
      email: "lucianaenzo2607@gmail.com",
      city: "Rosário do Sul",
      state: "RS",
      tshirtSize: "P",
      emergencyName: "Contato de emergência",
      emergencyPhone: normalizePhone("55 996702009"),
      healthInfo: null,
      extras: [],
    },
    {
      fullName: "Jesse Trindade dos Santos",
      cpf: normalizeCPF("008.381.290-30"),
      birthDate: normalizeDateBR("28/01/1983"),
      phone: normalizePhone("55997145908"),
      email: "prefeitojessetrindade@gmail.com",
      city: null,
      state: "RS",
      tshirtSize: "M",
      emergencyName: "Lara",
      emergencyPhone: normalizePhone("55 997145008"),
      healthInfo: null,
      extras: [],
    },
    {
      fullName: "Laize Machado da Costa",
      cpf: normalizeCPF("010.498.930-00"),
      birthDate: normalizeDateBR("17/10/1984"),
      phone: normalizePhone("55 996771444"),
      email: "laize.mc@gmail.com",
      city: null,
      state: "RS",
      tshirtSize: "P",
      emergencyName: "Contato de emergência",
      emergencyPhone: normalizePhone("55 996771444"),
      healthInfo: null,
      extras: [],
    },
    {
      fullName: "Mosiah Gomes Davila",
      cpf: normalizeCPF("006.802.450-90"),
      birthDate: normalizeDateBR("24/10/1994"),
      phone: normalizePhone("055996817973"),
      email: "mosiahgd@outlook.com",
      city: null,
      state: "RS",
      tshirtSize: "G",
      emergencyName: "Contato de emergência",
      emergencyPhone: normalizePhone("99953-3891"),
      healthInfo: null,
      extras: [],
    },
  ];
