// scripts/manual-diversao-gabriel.ts
...
async function main() {
  ...
  const participants = [
    {
      fullName: "Gabriel de David Danieli",
      cpf: normalizeCPF("032.239.760-00"),
      birthDate: normalizeDateBR("26/08/1994"),
      phone: normalizePhone("55999238382"),
      email: "gabriel.danieli@outlook.com",
      city: null,
      state: "RS",
      tshirtSize: "Sem_camiseta",
      emergencyName: null,
      emergencyPhone: normalizePhone("55999237939"),
      healthInfo: null,
      extras: [],
    },
  ];
