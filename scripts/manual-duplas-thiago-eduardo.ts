// scripts/manual-duplas-thiago-eduardo.ts
...
async function main() {
  ...
  const participants = [
    {
      fullName: "Thiago Guedes Brezolin",
      cpf: normalizeCPF("02488575097"),
      birthDate: normalizeDateBR("22/05/2002"),
      phone: normalizePhone("(55)999485078"),
      email: "thiagogbrezolin@hotmail.com",
      city: null,
      state: "RS",
      tshirtSize: "SEM_CAMISETA",
      emergencyName: "Gabriela",
      emergencyPhone: normalizePhone("(55)997011504"),
      healthInfo: null,
      extras: [],
    },
    {
      fullName: "Eduardo Saenger Potter",
      cpf: normalizeCPF("04194945026"),
      birthDate: normalizeDateBR("14/07/02"),
      phone: normalizePhone("55992170102"),
      email: "eduardosaenger@hotmail.com",
      city: null,
      state: "RS",
      tshirtSize: "SEM_CAMISETA",
      emergencyName: "Verônica Saenger Potter",
      emergencyPhone: normalizePhone("55999892416"),
      healthInfo: null,
      extras: [],
    },
  ];
