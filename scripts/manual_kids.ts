// scripts/manual-kids-maria-clara.ts
...
// ===================== CONFIG RÁPIDA =====================
const MODALITY_ID: ModalityId = "kids";
const TICKETS = 1;
...
async function main() {
  ...
  // ========= PARTICIPANTE (KIDS - INDIVIDUAL) =========
  const participants = [
    {
      fullName: "Maria Clara Roos Dal Sasso",
      cpf: normalizeCPF("064.431.390-03"),
      birthDate: normalizeDateBR("30/01/2016"),
      phone: normalizePhone("55999161941"),
      email: "betina_acostaroos@hotmail.com",
      city: null,
      state: "RS",
      tshirtSize: "14",
      emergencyName: "Responsável",
      emergencyPhone: normalizePhone("55999161941"),
      healthInfo: null,
      extras: [],
    },
  ];
  ...
  const order = await prisma.$transaction(
    async (tx) => {
      // ✅ kids/individual: 1 bib por participante
