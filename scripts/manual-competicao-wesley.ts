// scripts/manual-competicao-wesley.ts
...
async function main() {
  ...
  const participants = [
    {
      fullName: "Wesley Trindade Peres",
      cpf: normalizeCPF("00445784075"),
      birthDate: normalizeDateBR("02/11/1982"),
      phone: normalizePhone("55981493177"),
      email: "vbtpwesley@gmail.com",
      city: null,
      state: "RS",
      tshirtSize: "M",
      emergencyName: "Lucélia",
      emergencyPhone: normalizePhone("55991359962"),
      healthInfo: null,
      extras: [],
    },
  ];
