  ...
  return (
    <main className="min-h-screen bg-black px-4 py-24 text-white">
      <div className="mx-auto max-w-xl rounded-3xl border border-orange-500/30 p-7">
        ...
        <p className="mt-4">Seu pagamento já foi recebido diretamente pela organização. Sua inscrição está registrada como paga, na categoria pagamento por fora.</p>
        <p className="mt-3 text-zinc-300">Guarde esta confirmação. Se precisar de ajuda com sua inscrição, entre em contato com a organização.</p>
